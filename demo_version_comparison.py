...
>>> ✓ VERSION MATCH: Device version 3.1.5 matches filename version 3.1.5 (string match) <<<
>>> ✓ VERSION VERIFICATION PASSED: Device version matches filename! <<<
...
"""
    ...
    features = [
        "✓ Automatic version extraction from filename (e.g., app_2-1-7.ota → 2.1.7)",
        "✓ Hex to decimal conversion (e.g., 0x02010007 → 2.1.7)", 
        "✓ Multiple matching strategies (decimal, string, trailing .0 handling)",
        "✓ Clear SUCCESS/FAILURE indication in log output",
        "✓ Support for various filename formats and paths",
